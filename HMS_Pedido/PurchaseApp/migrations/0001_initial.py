    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='PurchaseApp.issuedetails')),
                ('item_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='SettingsApp.purchaseitems')),
                ('purchase', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='PurchaseApp.purchasedetails')),
            ],
            options={
                'abstract': False,
            },
